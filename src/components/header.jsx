...
const Header = () => {
  ...
  return (
    <header className='flex justify-between items-center mb-5 py-5 sm:px-10 px-8'>
        <Link to="/" className='text-xl font-semibold bg-blue-300 p-2 rounded'>HomeDecor.</Link>

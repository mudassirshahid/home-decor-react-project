...
import bannerImg from "../../src/assets/images/2.png";
import bannerImgNext from "../../src/assets/images/5.png";
...
function CustomCarousel() {
  ...
  return (
    <>
    <AntCarousel autoplay autoplaySpeed={2500} draggable="true" effect="fade" infinite="true">
      <div className="px-10  h-auto">
        <div className="flex sm:flex-row flex-col justify-center items-center mx-auto">
          <div className="sm:text-left text-center sm:w-[50%] w-full sm:px-0 px-5 lg:mt-0 mt-16">
      ...
      <div className="bg-slate-200 px-10  h-auto">
        <div className="flex sm:flex-row flex-col justify-center items-center mx-auto">
          ...
          <img className="lg:w-[40%] md:w-[50%] w-[60%]" src={bannerImgNext} alt="banner Iamge" />
        </div>
      </div>
    </AntCarousel>
    </>
